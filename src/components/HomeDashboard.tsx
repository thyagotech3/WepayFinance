    ...
    <div className="space-y-2.5 sm:space-y-4 max-w-xl lg:max-w-7xl mx-auto pb-24">
      ...
      <div className="space-y-2.5 sm:space-y-4 lg:space-y-0 lg:grid lg:grid-cols-12 lg:gap-5">
        ...
        <div className="lg:col-span-8 space-y-2.5 sm:space-y-4">
          ...
          {/* ================= 4 ACTION BUTTON CARDS (Mobile only - Desktop has them in the top navbar) ================= */}
          <div className="md:hidden grid grid-cols-4 gap-1.5 sm:gap-2.5">
            {/* Button 1: NOVA DESPESA */}
            <button
              type="button"
              onClick={onOpenExpenseModal}
              className="bg-gradient-to-b from-[#1c122e] to-[#0e1220] border border-purple-500/30 hover:border-purple-400 rounded-2xl p-1.5 sm:p-3 aspect-auto py-2 sm:py-3.5 transition-all duration-200 hover:scale-[1.02] flex flex-col items-center justify-center text-center cursor-pointer shadow-lg group relative overflow-hidden"
            >
              <div className="p-1.5 bg-pink-500/15 text-pink-400 rounded-xl border border-pink-500/30 group-hover:scale-110 transition-transform mb-1 shrink-0">
                <Wallet className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </div>
              <span className="text-[9.5px] sm:text-[11px] font-black text-white uppercase tracking-tight block group-hover:text-pink-300 transition-colors leading-tight">
                Despesa
              </span>
              <span className="text-[8px] text-slate-400 block mt-0.5 font-medium line-clamp-1">
                Rápida
              </span>
            </button>
            ...
            {/* Button 3: GASTOS FIXOS */}
            <button
              type="button"
              onClick={onOpenFixedExpenses}
              className="bg-gradient-to-b from-[#241a12] to-[#0e1220] border border-amber-500/30 hover:border-amber-400 rounded-2xl p-1.5 sm:p-3 aspect-auto py-2 sm:py-3.5 transition-all duration-200 hover:scale-[1.02] flex flex-col items-center justify-center text-center cursor-pointer shadow-lg group relative overflow-hidden"
            >
              <div className="p-1.5 bg-amber-500/15 text-amber-400 rounded-xl border border-amber-500/30 group-hover:scale-110 transition-transform mb-1 shrink-0">
                <Calendar className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </div>
              <span className="text-[9.5px] sm:text-[11px] font-black text-white uppercase tracking-tight block group-hover:text-amber-300 transition-colors leading-tight">
                Fixas
              </span>
              <span className="text-[8px] text-slate-400 block mt-0.5 font-medium line-clamp-1">
                Recorrentes
            ...
            {/* Button 4: ARRECADAÇÃO */}
            <button
              type="button"
              onClick={onOpenIncomeModal}
              className="bg-gradient-to-b from-[#10241b] to-[#0e1220] border border-teal-500/30 hover:border-teal-400 rounded-2xl p-1.5 sm:p-3 aspect-auto py-2 sm:py-3.5 transition-all duration-200 hover:scale-[1.02] flex flex-col items-center justify-center text-center cursor-pointer shadow-lg group relative overflow-hidden"
            >
              <div className="p-1.5 bg-teal-500/15 text-teal-400 rounded-xl border border-teal-500/30 group-hover:scale-110 transition-transform mb-1 shrink-0">
                <Users className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              </div>
              <span className="text-[9.5px] sm:text-[11px] font-black text-white uppercase tracking-tight block group-hover:text-teal-300 transition-colors leading-tight">
                Entradas
              </span>
              <span className="text-[8px] text-slate-400 block mt-0.5 font-medium line-clamp-1">
                Família
